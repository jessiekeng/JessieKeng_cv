  ...
  projects: [
    [
      ...
      },
      {
        ...
        active: true,
        description:
          "Architected a secure MERN backend with JWT-based authentication and role-based authorization. Engineered a robust CI/CD pipeline using GitHub Actions to automate ESLint v9 quality gates and asynchronous integration testing, ensuring 100% build reliability.",
        technologies: [
          "Node.js",
          "Express",
          "MongoDB",
      ...
      },
      {
        ...
        active: true,
        description:
          "Developed a full-stack task management system with an Angular frontend and a Node.js/Express backend. Implemented RESTful APIs for CRUD operations and integrated MongoDB Atlas for data persistence.",
        technologies: [
          "Angular",
          "Node.js",
          "Express",
